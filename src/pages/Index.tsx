    ...
    <div className="min-h-screen bg-black overflow-x-hidden">
          ...
          <div className="relative">
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-4">
                <div className="bg-gradient-to-br from-orange-600 to-red-700 rounded-lg p-4 h-32 flex items-center justify-center">
                  <span className="text-white font-bold text-lg">UNTIL DAWN</span>
                </div>
                <div className="bg-gradient-to-br from-red-800 to-red-900 rounded-lg p-4 h-24 flex items-center justify-center">
                  <span className="text-white font-bold">SINNERS</span>
                </div>
              </div>
              <div className="space-y-4 mt-8">
                <div className="bg-gradient-to-br from-blue-700 to-blue-900 rounded-lg p-4 h-24 flex items-center justify-center">
                  <span className="text-white font-bold text-sm">MINECRAFT</span>
                </div>
                <div className="bg-gradient-to-br from-gray-700 to-gray-900 rounded-lg p-4 h-32 flex items-center justify-center">
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="relative order-2 lg:order-1">
            <div className="grid grid-cols-3 gap-4">
              {/* Row 1 */}
              <div className="bg-[#146EB4] rounded-lg p-3 h-20 flex items-center justify-center">
                <span className="text-white font-bold text-sm">prime video</span>
              </div>
              <div className="bg-orange-600 rounded-lg p-3 h-20 flex items-center justify-center">
                <span className="text-white font-bold text-sm">REACHER</span>
              </div>
              <div className="bg-black rounded-lg p-3 h-20 flex items-center justify-center border border-gray-600">
                <span className="text-white font-bold text-sm">tv+</span>
              </div>
              
              {/* Row 2 */}
              <div className="bg-blue-600 rounded-lg p-3 h-20 flex items-center justify-center">
                <span className="text-white font-bold text-sm">MOANA 2</span>
              </div>
              <div className="bg-red-600 rounded-lg p-3 h-20 flex items-center justify-center">
                <span className="text-white font-bold text-sm">YouTube</span>
              </div>
              <div className="bg-teal-600 rounded-lg p-3 h-20 flex items-center justify-center">
              ...
              <div className="bg-blue-900 rounded-lg p-3 h-20 flex items-center justify-center">
                <span className="text-white font-bold text-sm">peacock</span>
              </div>
              
              {/* Row 4 */}
              <div className="bg-teal-700 rounded-lg p-3 h-20 flex items-center justify-center">
                <span className="text-white font-bold text-sm">Hacks</span>
              </div>
              <div className="bg-purple-800 rounded-lg p-3 h-20 flex items-center justify-center">
                <span className="text-white font-bold text-sm">max</span>
              </div>
              <div className="bg-gray-600 rounded-lg p-3 h-20 flex items-center justify-center">
      ...
      <div className="min-h-screen bg-black flex flex-col items-center justify-center px-6">
        ...
        <div className="w-full max-w-7xl mx-auto mt-auto pb-8">
          <div className="border border-gray-600 rounded-lg p-6 flex justify-between items-center">
